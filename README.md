...
Wouldn't you be able to translate the caption of the following photograph in Vietnamese, huh?
...
Don't waste your time in creating the conversion **hash table** between a language **(ISO 639-1:2002)** and its arbitrary corresponding country **(ISO 3166-1 alpha-2)**.
Here it is:
